...
public static class GfzCliUtilities
{
    ...
    public static int ParallelizeFileInFileOutTasks(Options options, FileInFileOutTask fileTask, bool runLinear = false)
    {
        ...
        for (int i = 0; i < inputFilePaths.Length; i++)
        {
            ...
            // Potential bypass to make linear for testing.
            if (runLinear)
                task.Wait(10_000);
        }
        ...
        if (directoryExists)
        {
            ...
            if (isInvalidSearchOption)
            {
                string msg =
                    ...
                    $"Make sure to use --{CliArgumentText.SearchPattern} when providing directory paths.";
    ...
    public static string CreateBackupFile(OSPath filePath)
    {
        ...
        string timeMarker = dateTime.ToString("HH-mm-ss-fff");
